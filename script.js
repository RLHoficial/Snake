...
document.getElementById("speedButton").addEventListener("click", setSpeed); // Agregar evento al nuevo botón
...
function setSpeed() {
    const newSpeed = parseInt(prompt("Enter the new speed in milliseconds (e.g., 100 for faster, 200 for slower):"));
    if (!isNaN(newSpeed)) {
        ...
        alert("Invalid input. Speed remains unchanged.");
    }
}
